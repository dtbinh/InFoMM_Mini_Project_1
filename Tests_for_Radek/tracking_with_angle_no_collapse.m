function [] = tracking_with_angle_no_collapse(L,T,a,b,g,e)
...
%% Examples
% tracking_with_angle_no_collapse(100,5001,10,10,10,100) w/ slow circ
% tracking_with_angle_no_collapse(100,5001,5,5,50,100) w/ stationary
...
%     dash_sum_V = dash_sum_V./(dash_factor_V).^zeta;
    ...
    dro_direc_A(t,:) = dro_vel_prev_V + ...
        ...
        dro_vel_prev_V - ...
        gamma*gamma_V - ...
        eta*y_repulsion_V + randn(1,8).*dash_magnitude_V*min(5,t/100))*dt_S;
