function [] = twelve_no_collapse(L,T,a,b,g,m)
...
%% Examples
% twelve_no_collapse(100,5001,5,5,50,100)
...
h8 = animatedline('Color','m','MaximumNumPoints',50,'LineStyle','-.');
h9 = animatedline('Color','k','MaximumNumPoints',50,'LineStyle','-.');
h10 = animatedline('Color','b','MaximumNumPoints',50,'LineStyle','--');
h11 = animatedline('Color','r','MaximumNumPoints',50,'LineStyle','--');
h12 = animatedline('Color','m','MaximumNumPoints',50,'LineStyle','--');
h13 = animatedline('Color','k','MaximumNumPoints',50,'LineStyle','--');
sqax = 30;
